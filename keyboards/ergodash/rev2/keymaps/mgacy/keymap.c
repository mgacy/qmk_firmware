 ...
 * |-/MEH---+--------+--------+--------+--------+--------+--------|                          |--------+--------+--------+--------+--------+--------+--------|
 * | TAB    | Q      | W      | E      | R      | T      | INS    |                          | PG UP  | Y      | U      | I      | O      | P      | '      |
 * |--------+--------+--------+--------+--------+--------+--------|                          |--------+--------+--------+--------+--------+--------|--------|
 * | ESC    | A      | S      | D      | F      | G      | DEL    |                          | PG DN  | H      | J      | K      | L      | ;      | RETURN |
 * |-/HYPER-+-/NUMBR-+--------+-/SYMBL-+-/TEXT--+--------+--------+--------.        .--------+--------+--------+--------+--------+--------+-/NAV---+--------|
 * | LSHIFT | Z      | X      | C      | V      | B      | ?????? |        |        |        | ?????? | N      | M      | ,      | .      | /      | RSHIFT |
 * |-/(-----+-/SLECT-+--------+--------+--------+--------+--------| SHIFT  |        | SHIFT  |--------+-/FN----+--------+--------+--------+-/)-----|--------|
 * | FN     | LCTRL  | LALT   | LGUI   |||||||||| BACKSP | BACKSP |        |        |        | SPACE  | ?????  |||||||||| RGUI   | ENTER  | ????   | MOUSE  |
 * '-------------------------------------------------------/CTRL-----------'        '----------/CMND----/OPT------------------------------------------------'
 */

  /* QWERTY */
  [_QW] = LAYOUT( \
    MEH_GRV, KC_1   , KC_2   , KC_3   , KC_4   , KC_5   , KC_LPRN                           , KC_RPRN, KC_6   , KC_7   , KC_8   , KC_9   , KC_0   , KC_BSPC, \
    KC_TAB , KC_Q   , KC_W   , KC_E   , KC_R   , KC_T   , KC_LCBR                           , KC_RCBR, KC_Y   , KC_U   , KC_I   , KC_O   , KC_P   , KC_QUOT, \
    HPR_ESC, NM_KC_A, KC_S   , SY_KC_D, TX_KC_F, KC_G   , KC_LBRC                           , KC_RBRC, KC_H   , KC_J   , KC_K   , KC_L   , NAV_SCL, KC_ENT , \
    KC_LSFT, TS_KC_Z, KC_X   , KC_C   , KC_V   , KC_B   , KC_LALT                           , KC_LGUI, KC_N   , FN_KC_M, KC_COMM, KC_DOT , KC_SLSH, KC_RSFT, \
    MO(_FN), KC_LCTL, KC_LALT, KC_LGUI         , KC_LCTL, KC_BSPC, KC_LSFT         , KC_RSFT, KC_SPC , KC_DEL          , KC_LEFT, KC_DOWN, KC_UP  , MO(_MS)  \
  ),
 ...
 */
  ...
  [_NM] = LAYOUT( \
    ...
    _______, _______, KC_LALT, KC_LCMD, KC_PDOT, _______, _______                           , _______, KC_PMNS, KC_P4  , KC_P5  , KC_P6  , KC_PSLS, _______, \
    _______, _______, _______, _______, _______, _______, _______                           , _______, _______, KC_P1  , KC_P2  , KC_P3  , _______, _______, \
    _______, _______, _______, _______         , _______, _______, _______         , _______, KC_EQL , KC_0            , KC_PDOT, _______, _______, _______  \
  ),
 ...
 */
  ...
  /* FUNCTION */
  [_FN] = LAYOUT( \
    KC_SLEP, BRGT_DN, BRGT_UP, MSSN_CL, _______, _______, _______                           , _______, _______, _______, _______, _______, _______, _______, \
    MO(_KB), KC_F1  , KC_F2  , KC_F3  , KC_F4  , _______, _______                           , _______, _______, _______, _______, _______, _______, _______, \
 ...
 */
  ...
  /* SYMBOL */
  [_SY] = LAYOUT( \
    _______, _______, _______, _______, _______, _______, _______                           , KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, _______, _______, _______, \
    _______, _______, _______, _______, _______, _______, _______                           , _______, KC_PLUS, KC_DQT , KC_EXLM, KC_AT  , KC_UNDS, KC_AMPR, \
    _______, _______, _______, _______, _______, _______, _______                           , _______, KC_MINS, TD_CRLY, TD_PARN, TD_BRKT, KC_COLN, _______, \
    _______, _______, _______, _______, _______, _______, _______                           , KC_PIPE, KC_BSLS, KC_QUOT, TD_ANBK, KC_ASTR, KC_QUES, KC_DLR , \
    _______, _______, _______, _______         , _______, _______, _______         , KC_HASH, KC_EQL , _______         , _______, TD_CMNT, KC_SLSH, _______ \
  ),
 ...
 * |        |        |        |        |        |        |        |                          |        |        |        |        |        |        |        |
 * |--------+--------+--------+--------+--------+--------+--------|                          |--------+--------+--------+--------+--------+-----------------|
 * |        | SPACE1 | SPACE2 | SPACE3 | SPACE4 |        |        |                          |        | HOME   | PG UP  | FORWRD |        |        |        |
 * |--------+--------+--------+--------+--------+--------+--------|                          |--------+--------+--------+--------+-----------------+--------|
 * |        | SPACE+ | APP+   | WIN+   | TAB+   | TAB2+  |        |                          |        | LEFT   | DOWN   | UP     | RIGHT  | ^^^^^^ |        |
 * |--------+--------+--------+--------+--------+--------+--------+--------.        .--------+--------+--------+--------+--------------------------+--------|
 * |        | SPACE- | APP-   | WIN-   | TAB-   | TAB2-  |        |        |        |        |        | END    | PG DN  | BACK   |        |        |        |
 * |--------+--------+--------+--------+--------+--------+--------|        |        |        +--------+--------+--------+-----------------+--------+--------|
 * |        |        |        |        ||||||||||        |        |        |        |        |        |        ||||||||||        |        |        |        |
 * '-----------------------------------------------------------------------'        '-----------------------------------------------------------------------'
 */
  ...
  [_NV] = LAYOUT( \
    _______, _______, _______, _______, _______, _______, _______                           , _______, _______, _______, _______, _______, _______, _______, \
    _______, SPC_ONE, SPC_TWO, SPC_THR, SPC_FOR, _______, _______                           , _______, KC_HOME, KC_PGUP, FRWD   , _______, _______, _______, \
    _______, _______, NXT_APP, NXT_WIN, NXT_TAB, NXT_ATB, _______                           , _______, KC_LEFT, KC_DOWN, KC_UP  , KC_RGHT, _______, _______, \
    _______, _______, PRV_APP, PRV_WIN, PRV_TAB, PRV_ATB, _______                           , _______, KC_END , KC_PGDN, BACK   , _______, _______, _______, \
    _______, _______, _______, _______         , _______, _______, _______         , _______, _______, _______         , _______, _______, _______, _______  \
  ),
 ...
 */
  ...
  [_TX] = LAYOUT( \
    _______, _______, _______, _______, _______, _______, _______                           , _______, _______, _______, _______, _______, _______, _______, \
    _______, _______, _______, _______, _______, _______, _______                           , _______, _______, _______, _______, _______, _______, _______, \
    _______, _______, _______, _______, _______, _______, _______                           , _______, SHFT_LT, MV_L_DN, MV_L_UP, SHFT_RT, XXXXXXX, _______, \
    _______, _______, _______, _______, _______, _______, _______                           , _______, _______, _______, _______, _______, _______, _______, \
    _______, _______, _______, _______         , _______, _______, _______         , _______, _______, _______         , _______, _______, _______, _______  \
  ),
 ...
 */
  ...
  [_TS] = LAYOUT( \
    _______, _______, _______, _______, _______, _______, _______                           , _______, _______, _______, _______, _______, _______, _______, \
    _______, _______, _______, _______, _______, _______, _______                           , _______, ESL_CHL, ESL_DWN, ESL_UP , ESL_CHR, _______, _______, \
    _______, _______, _______, _______, _______, _______, _______                           , _______, ESL_WDL, ESL_PGD, ESL_PGU, ESL_WDR, XXXXXXX, _______, \
    _______, _______, CUT    , COPY   , PASTE  , HSTRY  , _______                           , _______, ESL_LNB, ESL_DCE, ESL_DCB, ESL_LNE, _______, _______, \
    _______, _______, _______, _______         , _______, _______, _______         , _______, SEL_WRD, SEL_PGH         , _______, _______, _______, _______  \
  ),
 ...
 */
  ...
  [_MS] = LAYOUT( \
    ...
    _______, _______, KC_WH_L, KC_MS_U, KC_WH_D, _______, _______                           , _______, _______, _______, _______, _______, _______, _______, \
    _______, _______, KC_MS_L, KC_MS_D, KC_MS_R, _______, _______                           , _______, _______, _______, _______, _______, _______, _______, \
    _______, _______, KC_WH_R, _______, KC_WH_U, _______, _______                           , _______, _______, _______, _______, _______, _______, _______, \
